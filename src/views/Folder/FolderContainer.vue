      ...
      <div class="folders-column">
        <div class="page-header">
          ...
          <div class="header-buttons">
            <router-link :to="{ path: `/files` }" v-if="showBackButton" class="back-link">
            ...
            <button data-bs-toggle="offcanvas" data-bs-target="#offcanvasCreate" class="btn btn-sm btn-outline-primary"
              action="Create Button" :guard="this.$route.meta.guard" @click="setCreateForm">
